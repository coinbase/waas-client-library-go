...
// 	protoc        (unknown)
// source: coinbase/cloud/protocols/ethereum/inputs.proto
...
func (x *EIP1559TransactionInput) Reset() {
	*x = EIP1559TransactionInput{}
	if protoimpl.UnsafeEnabled {
		mi := &file_coinbase_cloud_protocols_ethereum_inputs_proto_msgTypes[0]
...
func (*EIP1559TransactionInput) Descriptor() ([]byte, []int) {
	return file_coinbase_cloud_protocols_ethereum_inputs_proto_rawDescGZIP(), []int{0}
}
...
func (x *RLPTransaction) Reset() {
	*x = RLPTransaction{}
	if protoimpl.UnsafeEnabled {
		mi := &file_coinbase_cloud_protocols_ethereum_inputs_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*RLPTransaction) Descriptor() ([]byte, []int) {
	return file_coinbase_cloud_protocols_ethereum_inputs_proto_rawDescGZIP(), []int{1}
}
...
func (x *DynamicFeeInput) Reset() {
	*x = DynamicFeeInput{}
	if protoimpl.UnsafeEnabled {
		mi := &file_coinbase_cloud_protocols_ethereum_inputs_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*DynamicFeeInput) Descriptor() ([]byte, []int) {
	return file_coinbase_cloud_protocols_ethereum_inputs_proto_rawDescGZIP(), []int{2}
}
...
var File_coinbase_cloud_protocols_ethereum_inputs_proto protoreflect.FileDescriptor

var file_coinbase_cloud_protocols_ethereum_inputs_proto_rawDesc = []byte{
	0x0a, 0x2e, 0x63, 0x6f, 0x69, 0x6e, 0x62, 0x61, 0x73, 0x65, 0x2f, 0x63, 0x6c, 0x6f, 0x75, 0x64,
	0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x63, 0x6f, 0x6c, 0x73, 0x2f, 0x65, 0x74, 0x68, 0x65, 0x72,
	0x65, 0x75, 0x6d, 0x2f, 0x69, 0x6e, 0x70, 0x75, 0x74, 0x73, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f,
	0x12, 0x21, 0x63, 0x6f, 0x69, 0x6e, 0x62, 0x61, 0x73, 0x65, 0x2e, 0x63, 0x6c, 0x6f, 0x75, 0x64,
	0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x63, 0x6f, 0x6c, 0x73, 0x2e, 0x65, 0x74, 0x68, 0x65, 0x72,
	0x65, 0x75, 0x6d, 0x22, 0xa7, 0x02, 0x0a, 0x17, 0x45, 0x49, 0x50, 0x31, 0x35, 0x35, 0x39, 0x54,
	...
	0x09, 0x52, 0x07, 0x63, 0x68, 0x61, 0x69, 0x6e, 0x49, 0x64, 0x12, 0x14, 0x0a, 0x05, 0x6e, 0x6f,
	...
	,
	...
	0x61, 0x73, 0x42, 0x57, 0x5a, 0x55, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x62, 0x68,
	...
	0x73, 0x65, 0x2f, 0x63, 0x6c, 0x6f, 0x75, 0x64, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x63, 0x6f,
	0x6c, 0x73, 0x2f, 0x65, 0x74, 0x68, 0x65, 0x72, 0x65, 0x75, 0x6d, 0x62, 0x06, 0x70, 0x72, 0x6f,
	0x74, 0x6f, 0x33,
}

var (
	file_coinbase_cloud_protocols_ethereum_inputs_proto_rawDescOnce sync.Once
	file_coinbase_cloud_protocols_ethereum_inputs_proto_rawDescData = file_coinbase_cloud_protocols_ethereum_inputs_proto_rawDesc
)

func file_coinbase_cloud_protocols_ethereum_inputs_proto_rawDescGZIP() []byte {
	file_coinbase_cloud_protocols_ethereum_inputs_proto_rawDescOnce.Do(func() {
		file_coinbase_cloud_protocols_ethereum_inputs_proto_rawDescData = protoimpl.X.CompressGZIP(file_coinbase_cloud_protocols_ethereum_inputs_proto_rawDescData)
	})
	return file_coinbase_cloud_protocols_ethereum_inputs_proto_rawDescData
}

var file_coinbase_cloud_protocols_ethereum_inputs_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_coinbase_cloud_protocols_ethereum_inputs_proto_goTypes = []interface{}{
	(*EIP1559TransactionInput)(nil), // 0: coinbase.cloud.protocols.ethereum.EIP1559TransactionInput
	(*RLPTransaction)(nil),          // 1: coinbase.cloud.protocols.ethereum.RLPTransaction
	(*DynamicFeeInput)(nil),         // 2: coinbase.cloud.protocols.ethereum.DynamicFeeInput
}
var file_coinbase_cloud_protocols_ethereum_inputs_proto_depIdxs = []int32{
...
func init() { file_coinbase_cloud_protocols_ethereum_inputs_proto_init() }
func file_coinbase_cloud_protocols_ethereum_inputs_proto_init() {
	if File_coinbase_cloud_protocols_ethereum_inputs_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_coinbase_cloud_protocols_ethereum_inputs_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_coinbase_cloud_protocols_ethereum_inputs_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_coinbase_cloud_protocols_ethereum_inputs_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_coinbase_cloud_protocols_ethereum_inputs_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_coinbase_cloud_protocols_ethereum_inputs_proto_goTypes,
		DependencyIndexes: file_coinbase_cloud_protocols_ethereum_inputs_proto_depIdxs,
		MessageInfos:      file_coinbase_cloud_protocols_ethereum_inputs_proto_msgTypes,
	}.Build()
	File_coinbase_cloud_protocols_ethereum_inputs_proto = out.File
	file_coinbase_cloud_protocols_ethereum_inputs_proto_rawDesc = nil
	file_coinbase_cloud_protocols_ethereum_inputs_proto_goTypes = nil
	file_coinbase_cloud_protocols_ethereum_inputs_proto_depIdxs = nil
}
