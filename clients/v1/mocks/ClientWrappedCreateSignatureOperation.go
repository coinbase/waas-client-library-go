...
func (_m *ClientWrappedCreateSignatureOperation) Metadata() (*mpc_keysv1.CreateSignatureMetadata, error) {
	...
	var r0 *mpc_keysv1.CreateSignatureMetadata
	var r1 error
	if rf, ok := ret.Get(0).(func() (*mpc_keysv1.CreateSignatureMetadata, error)); ok {
		return rf()
	}
	if rf, ok := ret.Get(0).(func() *mpc_keysv1.CreateSignatureMetadata); ok {
		r0 = rf()
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*mpc_keysv1.CreateSignatureMetadata)
		}
	}
...
func (_m *ClientWrappedCreateSignatureOperation) Poll(ctx context.Context, opts ...gax.CallOption) (*mpc_keysv1.Signature, error) {
	...
	var r0 *mpc_keysv1.Signature
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, ...gax.CallOption) (*mpc_keysv1.Signature, error)); ok {
		return rf(ctx, opts...)
	}
	if rf, ok := ret.Get(0).(func(context.Context, ...gax.CallOption) *mpc_keysv1.Signature); ok {
		r0 = rf(ctx, opts...)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*mpc_keysv1.Signature)
		}
	}
...
// NewClientWrappedCreateSignatureOperation creates a new instance of ClientWrappedCreateSignatureOperation. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewClientWrappedCreateSignatureOperation(t interface {
	mock.TestingT
	Cleanup(func())
}) *ClientWrappedCreateSignatureOperation {
	mock := &ClientWrappedCreateSignatureOperation{}
	mock.Mock.Test(t)
