...
func (_m *ClientWrappedPrepareDeviceBackupOperation) Metadata() (*mpc_keysv1.PrepareDeviceBackupMetadata, error) {
	...
	var r0 *mpc_keysv1.PrepareDeviceBackupMetadata
	var r1 error
	if rf, ok := ret.Get(0).(func() (*mpc_keysv1.PrepareDeviceBackupMetadata, error)); ok {
		return rf()
	}
	if rf, ok := ret.Get(0).(func() *mpc_keysv1.PrepareDeviceBackupMetadata); ok {
		r0 = rf()
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*mpc_keysv1.PrepareDeviceBackupMetadata)
		}
	}
...
// NewClientWrappedPrepareDeviceBackupOperation creates a new instance of ClientWrappedPrepareDeviceBackupOperation. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewClientWrappedPrepareDeviceBackupOperation(t interface {
	mock.TestingT
	Cleanup(func())
}) *ClientWrappedPrepareDeviceBackupOperation {
	mock := &ClientWrappedPrepareDeviceBackupOperation{}
	mock.Mock.Test(t)
