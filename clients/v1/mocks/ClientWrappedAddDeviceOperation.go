...
func (_m *ClientWrappedAddDeviceOperation) Metadata() (*mpc_keysv1.AddDeviceMetadata, error) {
	...
	var r0 *mpc_keysv1.AddDeviceMetadata
	var r1 error
	if rf, ok := ret.Get(0).(func() (*mpc_keysv1.AddDeviceMetadata, error)); ok {
		return rf()
	}
	if rf, ok := ret.Get(0).(func() *mpc_keysv1.AddDeviceMetadata); ok {
		r0 = rf()
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*mpc_keysv1.AddDeviceMetadata)
		}
	}
...
// NewClientWrappedAddDeviceOperation creates a new instance of ClientWrappedAddDeviceOperation. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewClientWrappedAddDeviceOperation(t interface {
	mock.TestingT
	Cleanup(func())
}) *ClientWrappedAddDeviceOperation {
	mock := &ClientWrappedAddDeviceOperation{}
	mock.Mock.Test(t)
