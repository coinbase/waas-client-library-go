...
func (_m *ClientWrappedPrepareDeviceArchiveOperation) Metadata() (*mpc_keysv1.PrepareDeviceArchiveMetadata, error) {
	...
	var r0 *mpc_keysv1.PrepareDeviceArchiveMetadata
	var r1 error
	if rf, ok := ret.Get(0).(func() (*mpc_keysv1.PrepareDeviceArchiveMetadata, error)); ok {
		return rf()
	}
	if rf, ok := ret.Get(0).(func() *mpc_keysv1.PrepareDeviceArchiveMetadata); ok {
		r0 = rf()
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*mpc_keysv1.PrepareDeviceArchiveMetadata)
		}
	}
...
// NewClientWrappedPrepareDeviceArchiveOperation creates a new instance of ClientWrappedPrepareDeviceArchiveOperation. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewClientWrappedPrepareDeviceArchiveOperation(t interface {
	mock.TestingT
	Cleanup(func())
}) *ClientWrappedPrepareDeviceArchiveOperation {
	mock := &ClientWrappedPrepareDeviceArchiveOperation{}
	mock.Mock.Test(t)
